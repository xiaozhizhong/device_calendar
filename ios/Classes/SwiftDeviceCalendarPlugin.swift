...
public class SwiftDeviceCalendarPlugin: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case disableRemindersMethod:
            disableReminders(call, result)
        case enableRemindersMethod:
            enableReminders(call, result)
    ...
    private func createCalendar(_ call: FlutterMethodCall, _ result: FlutterResult) {
        ...
        do {
            ...
            else if eventStore.defaultCalendarForNewEvents != nil{
